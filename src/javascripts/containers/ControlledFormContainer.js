...
class ControlledFormContainer extends Component {
  ...
  onChangeEmail = e => {
    ...
    this.setState({
      ...
      errors: {
        ...this.state.errors,
        exampleEmail: emailErrors ? emailErrors.exampleEmail[0] : null
      }
    });
  };
  ...
  onChangePassword = e => {
    ...
    this.setState({
      ...
      errors: {
        ...this.state.errors,
        examplePassword: passwordErrors
          ? passwordErrors.examplePassword[0]
          : null
      }
    });
  };
  ...
  onChangeURL = e => {
    ...
    this.setState({
      ...
      errors: {
        ...this.state.errors,
        exampleURL: urlErrors ? urlErrors.exampleURL[0] : null
      }
    });
  };
